export const mentorsData = {
  software: {
    ...
    },
    {
      ...
      description: (
        <>
          I have 14+ years of experience in software engineering with 10+ years of experience in the payments domain. Having been a mentee, it helped to grow both personally/professionally and helped me to choose the right path in my career. I believe it is time for me to help and guide someone progress in their career and there cannot be a better platform than this to do it.
        </>
      ),
    },
    {
      ...
      description: (
        <>
          I started as a Grad consultant in ThoughtWorks after my Masters in Computer Applications. I have been working as a software developer in Agile for 8 years now. I have worked in different tech stacks including java, .Net, javascript projects. Adding to it, a Kotlin project for a short stint. I also have experience in leading the development teams.
        </>
      ),
    },
    ],
  ...
  product: {
    ...
    mentors: [
      ...
      },
      {
        ...
        description: (
          <>
            Michelle is the product manager of a mobile app in the finance sector focused on delivering great customer experience. She transitioned from a marketing role and has found this journey both incredibly challenging and fulfilling! Excited to share what it takes to be in product management and inspire people interested in the field.
          </>
        ),
      },
      {
        ...
        description: (
          <>
            I am a Product Manager for a tech company where I build products that creates a seamless shopping experience for our online store customers. I started in the eCommerce space over 10 years ago from my humble beginnings as a customer service specialist and worked my way through shifting to project management and now on to product management for one of the largest tech company in the world. In my various roles, I am genuinely passionate on effecting change by delivering exceptional customer experience that makes a positive impact in their everyday lives. I joined this group as a way to pay it forward and hopefully inspire others to get to their next goal.
          </>
        ),
      },
      {
        ...
        description: (
          <>
            Experience of around 15 years in: Project/Product/Program Management; Effectively Handling Business Analysis/Requirements Gathering/Workshops; Managing a team size of 20+ people; Stakeholder Management/ Vendor Management/ Production Support; Working with cross country teams; A good command over APAC working teams.
          </>
        ),
      },
    ],
  ...
  data: {
    ...
    mentors: [
      ...
      },
      {
        ...
        description: (
          <>
            Dr Mong Suan Yee has a diverse experience in research, product development, management and entrepreneurship. She is now a co-founder of a startup called Kumi Analytics (www.kumianalytics.com) which provides financial and economic analytics based on satellite dataset. She has decades of experience in wireless communication and software industries. She still actively codes and enjoys creating products.
          </>
        ),
      },
      {
        ...
        description: (
          <>
            Catherine is an evangelist for data and analytics literacy at economy, organisational and individual levels. She is the founder of DNA Capitals which drives competitive advantage for organisations in all industries through taking full advantage of the opportunities which arise from digitization and big data. As a data and analytics evangelist, she is an active member of Tech Talent Assembly (TTAB) association which nurtures tech talents for lifelong employability, learning and sharing. Catherine was formerly the Practice Chief of Analytics & Intelligent System at NUS Institute of Systems Science (NUS-ISS), where she imparted her experience and knowledge to graduate students, business leaders and ICT practitioners. She also continues to serve as adjunct lecturer and coach to NUS ISS students and short course participants.
          </>
        ),
      },
    ]
